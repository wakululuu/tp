...
public class MainWindow extends UiPart<Stage> {
    ...
    private ShiftListPanel shiftListPanel;
    ...
    @FXML
    private StackPane shiftListPanelPlaceholder;
    ...
    public WorkerListPanel getWorkerListPanel() {
        return workerListPanel;
    }

    public ShiftListPanel getShiftListPanel() {
        return shiftListPanel;
    }
