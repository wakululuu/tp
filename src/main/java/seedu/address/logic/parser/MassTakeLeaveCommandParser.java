...
public class MassTakeLeaveCommandParser {
    ...
    public MassTakeLeaveCommand parse(String args) throws ParseException {
        ...
        if (!arePrefixesPresent(argumentMultimap, PREFIX_WORKER, PREFIX_SHIFT_DAY, PREFIX_SHIFT_TIME)) {
            throw new ParseException(String.format(MESSAGE_INVALID_COMMAND_FORMAT, MassTakeLeaveCommand.MESSAGE_USAGE));
        }
        ...
        try {
            ...
            throw new ParseException(String.format(MESSAGE_INVALID_COMMAND_FORMAT,
                    MassTakeLeaveCommand.MESSAGE_USAGE), ive);
        }
