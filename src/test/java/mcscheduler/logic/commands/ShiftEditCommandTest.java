...
public class ShiftEditCommandTest {
    ...
    public void equals() {
        ...
        assertNotEquals(new ShiftEditCommand(TypicalIndexes.INDEX_SECOND_SHIFT, CommandTestUtil.DESC_FIRST_SHIFT), standardCommand);

        // different descriptor -> returns false
        assertNotEquals(new ShiftEditCommand(TypicalIndexes.INDEX_FIRST_SHIFT, CommandTestUtil.DESC_SECOND_SHIFT), standardCommand);
    }
