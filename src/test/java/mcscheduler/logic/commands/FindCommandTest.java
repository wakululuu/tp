...
public class FindCommandTest {
    ...
    private Model expectedModel = new ModelManager(McSchedulerBuilder.getTypicalMcScheduler(), new UserPrefs());
    ...
    public void execute_multipleKeywords_multipleWorkersFound() {
        ...
        expectedModel.updateFilteredWorkerList(predicate);
        assertCommandSuccess(command, model, expectedMessage, expectedModel);
        assertEquals(Arrays.asList(TypicalWorkers.CARL, TypicalWorkers.ELLE, TypicalWorkers.FIONA), model.getFilteredWorkerList());
    }
