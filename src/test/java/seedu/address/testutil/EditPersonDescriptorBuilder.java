...
public class EditPersonDescriptorBuilder {
    ...
    /**
     * Returns an {@code EditPersonDescriptor} with fields containing {@code worker}'s details
     */
    public EditPersonDescriptorBuilder(Worker worker) {
        descriptor = new EditPersonDescriptor();
        ...
        descriptor.setTags(worker.getTags());
    }
